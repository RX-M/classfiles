# Script to install a single node K8s cluster on an RX-M Lab VM with no CNI plugin
#
# To use:  $ curl https://raw.githubusercontent.com/RX-M/classfiles/master/k8s-no-cni.sh | sh
#
